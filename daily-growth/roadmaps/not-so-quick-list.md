...
- [x] Appearance page: add background sizing controls for fit, center, and tile.
- [x] Repo clone feature decision: do not add a dedicated clone UI because the terminal already handles cloning well.
- [x] Adjust the Markdown file tab menu appearance; it currently feels wonky.
- [x] Fix sidebar white/green line behavior; white lines are needed and the current green lines do not work.
...
- [x] Sketches: add a delete confirmation modal because the current X makes accidental deletion too easy.
- [ ] Licensing and credits: decide how to present licenses and credits for libraries used by the app.
