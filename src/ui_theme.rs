...
impl UiTheme {
    ...
    pub const fn dark() -> Self {
        Self {
            is_light: false,
            // Every dark surface is a neutral gray around the #242424 the
            // terminal and chrome already use. The earlier panel and editor
            // fills leaned blue, which read as a second color inside tabs.
            chrome_bg: 0x242424,
            bumper_bg: 0x242424,
            panel_bg: 0x242424,
            editor_bg: 0x242424,
            ...
            muted_text: 0xa6a6a6,
            sidebar_text: 0xb4b4b4,
            accent: 0x214966,
            primary_text: 0xffffff,
            queue_green: 0x6aff90,
            joined_groups: [0x6aff90, 0x6ab8ff, 0xc78bff, 0xffc46a],
            sidebar_row_selected_bg: 0x363636,
            sidebar_row_hover_bg: 0x2e2e2e,
            hover_bg: 0x2e2e2e,
            pressed_bg: 0x3a3a3a,
            focus_ring: 0x6ab8ff,
            disabled_text: 0x7a7a7a,
            selection_bg: 0x363636,
            reading_bg: 0x242424,
            danger: 0xff929b,
            warning: 0xffc46a,
            success: 0x6aff90,
